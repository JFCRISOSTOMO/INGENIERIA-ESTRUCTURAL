...
MODEL_PATH_XGB = str(_PROJECT_ROOT / "results" / "xgboost_model.joblib")
MODEL_PATH_RF = str(_PROJECT_ROOT / "results" / "random_forest_model.joblib")
    ...
    def _load_models(self):
        ...
        if self.model_xgb is None and self.model_rf is None:
            messagebox.showerror(
                ...
                f"No se encontraron modelos entrenados en {_PROJECT_ROOT / 'results'}.\n\n"
