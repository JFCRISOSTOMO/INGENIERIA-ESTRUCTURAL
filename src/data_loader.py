...
_DEFAULT_RAW_PATH = _PROJECT_ROOT / "data" / "raw" / "Concrete_Data.csv"
...
def load_raw_data(path: str = _DEFAULT_RAW_PATH) -> pd.DataFrame:
    """
...
def get_clean_data(path: str = _DEFAULT_RAW_PATH,
